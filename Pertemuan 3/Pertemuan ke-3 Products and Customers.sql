...
SELECT City FROM Customers UNION SELECT City FROM Products ORDER BY City;
...
SELECT *, rowid   FROM Employee   WHERE rowid  = 2;

SELECT * FROM Products ORDER BY Price ASC;
SELECT * FROM Products ORDER BY ProductName DESC;
SELECT * FROM Customers ORDER BY Country ASC, CustomerName DESC;

SELECT OrderID, OrderDate FROM Orders LIMIT 10;

SELECT City, COUNT(*) AS jumlah_pelanggan FROM pelanggan GROUP BY City;
